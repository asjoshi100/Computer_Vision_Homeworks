...
def build_histogram(grad_mag, grad_angle, cell_size):
    ...
    theta = np.array([[165,180],[0,15],[15,45],[45,75],[75,105],[105,135],[135,165]])*(np.pi/180)
...
def face_recognition(I_target, I_template):
    ...
    # bounding_box_supre = np.delete(bounding_box_supre, (3), axis=0)
